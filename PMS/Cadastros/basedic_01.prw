...
//--------------------------------------------------------------------
/*/{Protheus.doc} basedic_
Função de update de dicionários para compatibilização

@author TOTVS Protheus
@since  10/12/2020
@obs    Gerado por BASEDIC - V.6.4.3.2 EFS / Upd. V.5.1.0 EFS
@version 1.0
/*/
//--------------------------------------------------------------------
User Function BASEDIC_( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "BASEDIC_" )
				Else
					MsgStop( "Atualização não Realizada.", "BASEDIC_" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("123") .And. IIF(M->Z00_TPMOD == "3",Pertence("12"),Pertence("3"))', .T. }, ; //X3_VLDUSER
	{ '1=Saas;2=On Premise;3=Adesao/Setup/Servico'							, .T. }, ; //X3_CBOX
	{ '1=Saas;2=On Premise;3=Adesao/Setup/Servico'							, .T. }, ; //X3_CBOXSPA
	{ '1=Saas;2=On Premise;3=Adesao/Setup/Servico'							, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("1234567")  .And. (IIF(M->Z00_TPMOD == "3",Pertence("34"),Pertence("12567")))', .T. }, ; //X3_VLDUSER
	{ '1=TOTVS-Servicos;2=TOTVS-Service Desk;3=SAP-Cloud;4=SAP-OnPremise;5=SAP-Servicos;6=SAP-Service Desk;7=MiniProposta', .T. }, ; //X3_CBOX
	{ '1=TOTVS-Servicos;2=TOTVS-Service Desk;3=SAP-Cloud;4=SAP-OnPremise;5=SAP-Servicos;6=SAP-Service Desk;7=MiniProposta', .T. }, ; //X3_CBOXSPA
	{ '1=TOTVS-Servicos;2=TOTVS-Service Desk;3=SAP-Cloud;4=SAP-OnPremise;5=SAP-Servicos;6=SAP-Service Desk;7=MiniProposta', .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'Z00'																	, .T. }, ; //X3_ARQUIVO
	{ '23'																	, .T. }, ; //X3_ORDEM
	{ 'Z00_TPMOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Modelo'															, .T. }, ; //X3_TITULO
	{ 'Tipo Modelo'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Modelo'															, .T. }, ; //X3_TITENG
	{ 'Tipo Modelo'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Modelo'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Modelo'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ '1=Modulo;2=Escopo de Projeto;3=Licenca'								, .T. }, ; //X3_CBOX
	{ '1=Modulo;2=Escopo de Projeto;3=Licenca'								, .T. }, ; //X3_CBOXSPA
	{ '1=Modulo;2=Escopo de Projeto;3=Licenca'								, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'Z00'																	, .T. }, ; //X3_ARQUIVO
	{ '24'																	, .T. }, ; //X3_ORDEM
	{ 'Z00_TPSERV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tp.Servico'															, .T. }, ; //X3_TITULO
	{ 'Tp.Servico'															, .T. }, ; //X3_TITSPA
	{ 'Tp.Servico'															, .T. }, ; //X3_TITENG
	{ 'Tp.Servico'															, .T. }, ; //X3_DESCRIC
	{ 'Tp.Servico'															, .T. }, ; //X3_DESCSPA
	{ 'Tp.Servico'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IIF(M->Z00_TIPO $ "1256", "1","")'									, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ '1=Consultoria;2=Desenvolvimento'										, .T. }, ; //X3_CBOX
	{ '1=Consultoria;2=Desenvolvimento'										, .T. }, ; //X3_CBOXSPA
	{ '1=Consultoria;2=Desenvolvimento'										, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ 'IIF(M->Z00_TIPO $ "1256", .T.,.F.)'									, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("Z00") .Or. Empty()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ 'IIF(M->Z02_TIPO $ "1256",.T.,.F.)'									, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ '1'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "BASEDIC_01" ) ) ) ;
