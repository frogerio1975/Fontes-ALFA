...
//-------------------------------------------------------------------
/*/{Protheus.doc} ALFPMS20
Tela de Rateio do Contas a Receber.
...
/*/
//-------------------------------------------------------------------
User Function ALFPMS20()

Private aRotina    := MenuDef()
Private __lAtuaRat := .F.
Private cCadastro  := "Tela de Rateio do Contas a Receber"
...
AADD( aSEVxSE1, { "EV_FILIAL"  , "xFilial('SEV')" } )
AADD( aSEVxSE1, { "EV_PREFIXO" , "E1_PREFIXO"     } )
AADD( aSEVxSE1, { "EV_NUM"     , "E1_NUM"         } )
AADD( aSEVxSE1, { "EV_PARCELA" , "E1_PARCELA"     } )
AADD( aSEVxSE1, { "EV_TIPO"    , "E1_TIPO"        } )
AADD( aSEVxSE1, { "EV_CLIFOR"  , "E1_CLIENTE"     } )
AADD( aSEVxSE1, { "EV_LOJA"    , "E1_LOJA"        } )

AADD( aSEZxSEV, { "EZ_FILIAL"  , "xFilial('SEZ')" } )
AADD( aSEZxSEV, { "EZ_PREFIXO" , "E1_PREFIXO"     } )
AADD( aSEZxSEV, { "EZ_NUM"     , "E1_NUM"         } )
AADD( aSEZxSEV, { "EZ_PARCELA" , "E1_PARCELA"     } )
AADD( aSEZxSEV, { "EZ_TIPO"    , "E1_TIPO"        } )
AADD( aSEZxSEV, { "EZ_CLIFOR"  , "E1_CLIENTE"     } )
AADD( aSEZxSEV, { "EZ_LOJA"    , "E1_LOJA"        } )
AADD( aSEZxSEV, { "EZ_NATUREZ" , "SEVDETAIL.EV_NATUREZ"     } )

bPosValid := {|oModel| VldModel(oModel)}
oModel:= MpFormModel():New( "PMS20MVC" ,  /*bPreValid*/ , bPosValid, {|oModel| fCommit(oModel)},/*bCancel*/ )
oModel:SetDescription("Rateio Contas a Receber")

bLoadSE1 := {|oModel| LoadSE1(oModel)}
oModel:AddFields("SE1MASTER", /*cOwner*/, GetStrSE1(1), /*bPre*/, /*bPost*/, bLoadSE1)
oModel:SetPrimaryKey({"E1_FILIAL", "E1_PREFIXO", "E1_NUM", "E1_PARCELA", "E1_TIPO", "E1_CLIENTE", "E1_LOJA"})
oModel:GetModel("SE1MASTER"):SetDescription("Título Contas a Receber")
oModel:GetModel("SE1MASTER"):SetOnlyQuery(.T.)

bLoadSEV := {|oModel| LoadSEV(oModel)}
oModel:AddGrid("SEVDETAIL", "SE1MASTER", GetStrSEV(1), /*bLinePre*/, /*bLinePost*/, /*bPre*/, /*bLinePost*/, bLoadSEV)
oModel:SetRelation("SEVDETAIL", aSEVxSE1, "EV_FILIAL+EV_PREFIXO+EV_NUM+EV_PARCELA+EV_TIPO+EV_CLIFOR+EV_LOJA+EV_NATUREZ" )
...
oModel:AddCalc("TOTNAT", "SE1MASTER", "SEVDETAIL", "EV_VALOR", "SLD_EVVALOR", "FORMULA" , /*bCond*/, bInitSldNat   , "Saldo a Distribuir", bForSldNat  , 14, 2)
oModel:AddCalc("TOTNAT", "SE1MASTER", "SEVDETAIL", "EV_VALOR", "SUM_EVVALOR", "SUM"     , /*bCond*/, /*bInitValue*/, "Valor Distribuido" , /*bFormula*/, 14, 2)
oModel:AddCalc("TOTNAT", "SE1MASTER", "SEVDETAIL", "EV_PERC" , "SUM_EVPERC" , "SUM"     , /*bCond*/, /*bInitValue*/, "% Distribuido"     , /*bFormula*/, 14, 2)
...
oModel:SetVldActivate( { |oModel| PMS20ACT( oModel ) } )
...
Local oModel 	:= FwLoadModel("ALFPMS20")
Local oView 	:= Nil

oView := FwFormView():New()
oView:SetModel(oModel)

oView:AddField("VIEWSE1", GetStrSE1(2) , "SE1MASTER")
...
oView:SetOwnerView("VIEWSE1", "CABEC")
...
oView:EnableTitleView('VIEWSE1' , 'Contas a Receber'  )
...
/*/
//-------------------------------------------------------------------
Static Function GetStrSE1(nOpcao)
...
If nOpcao == 1	//Model
    ...
    oStruct:AddTable("SE1", {" "}, "Titulo Contas a Receber")
    ...
    oStruct:AddField("Filial"       , "Filial"      , "E1_FILIAL"  , "C", TamSX3("E1_FILIAL")[1] , TamSX3("E1_FILIAL")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Prefixo"      , "Prefixo"     , "E1_PREFIXO" , "C", TamSX3("E1_PREFIXO")[1], TamSX3("E1_PREFIXO")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("No.Titulo"    , "No.Titulo"   , "E1_NUM"     , "C", TamSX3("E1_NUM")[1]    , TamSX3("E1_NUM")[2]    , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Parcela"      , "Parcela"     , "E1_PARCELA" , "C", TamSX3("E1_PARCELA")[1], TamSX3("E1_PARCELA")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Tipo"         , "Tipo"        , "E1_TIPO"    , "C", TamSX3("E1_TIPO")[1]   , TamSX3("E1_TIPO")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Vlr.Titulo"   , "Vlr.Titulo"  , "E1_VALOR"   , "N", TamSX3("E1_VALOR")[1]  , TamSX3("E1_VALOR")[2]  , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Cliente"      , "Cliente"     , "E1_CLIENTE" , "C", TamSX3("E1_CLIENTE")[1], TamSX3("E1_CLIENTE")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Loja"         , "Loja"        , "E1_LOJA"    , "C", TamSX3("E1_LOJA")[1]   , TamSX3("E1_LOJA")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Fantasia"     , "Fantasia"    , "E1_NOMCLI"  , "C", TamSX3("E1_NOMCLI")[1] , TamSX3("E1_NOMCLI")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)

    oStruct:AddField("Emissão"      , "Emissão"     , "E1_EMISSAO" , "D", TamSX3("E1_EMISSAO")[1], TamSX3("E1_EMISSAO")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Vencto.Orig"  , "Vencto.Orig" , "E1_VENCORI" , "D", TamSX3("E1_VENCORI")[1], TamSX3("E1_VENCORI")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Vencimento"   , "Vencimento"  , "E1_VENCTO"  , "D", TamSX3("E1_VENCTO")[1] , TamSX3("E1_VENCTO")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Vencto.Real"  , "Vencto.Real" , "E1_VENCREA" , "D", TamSX3("E1_VENCREA")[1], TamSX3("E1_VENCREA")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Proposta"     , "Proposta"    , "E1_PROPOS"  , "C", TamSX3("E1_PROPOS")[1] , TamSX3("E1_PROPOS")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Histórico"    , "Histórico"   , "E1_HIST"    , "C", TamSX3("E1_HIST")[1]   , TamSX3("E1_HIST")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Numero NF"    , "Numero NF"   , "E1_XNUMNFS" , "C", TamSX3("E1_XNUMNFS")[1], TamSX3("E1_XNUMNFS")[2], {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("Dt.NFSe"      , "Dt.NFSe"     , "E1_XDTREC"  , "C", TamSX3("E1_XDTREC")[1] , TamSX3("E1_XDTREC")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("PIS"          , "PIS"         , "E1_PIS"     , "N", TamSX3("E1_PIS")[1]    , TamSX3("E1_PIS")[2]    , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("COFINS"       , "COFINS"      , "E1_COFINS"  , "N", TamSX3("E1_COFINS")[1] , TamSX3("E1_COFINS")[2] , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("CSLL"         , "CSLL"        , "E1_CSLL"    , "N", TamSX3("E1_CSLL")[1]   , TamSX3("E1_CSLL")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("IRRF"         , "IRRF"        , "E1_IRRF"    , "N", TamSX3("E1_IRRF")[1]   , TamSX3("E1_IRRF")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("ISS"          , "ISS"         , "E1_ISS"     , "N", TamSX3("E1_ISS")[1]    , TamSX3("E1_ISS")[2]    , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)
    oStruct:AddField("INSS"         , "INSS"        , "E1_INSS"    , "N", TamSX3("E1_INSS")[1]   , TamSX3("E1_INSS")[2]   , {|| .T.}, {|| .F.}, NIL, .F., NIL, .F., .T., .T., NIL)

    oStruct:SetProperty("E1_NOMCLI", MODEL_FIELD_INIT, FWBuildFeature( STRUCT_FEATURE_INIPAD, "Posicione('SA1',1,xFilial('SA1')+SE1->E1_CLIENTE+SE1->E1_LOJA,'A1_NREDUZ')"))
...
ElseIf nOpcao == 2	//View
    ...
    oStruct:AddField("E1_PREFIXO"  , "01", "Prefixo"   , "Prefixo"   , NIL, "C", PesqPict("SE1", "E1_PREFIXO") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_NUM"      , "02", "No.Titulo" , "No.Titulo" , NIL, "C", PesqPict("SE1", "E1_NUM")     , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_PARCELA"  , "03", "Parcela"   , "Parcela"   , NIL, "C", PesqPict("SE1", "E1_PARCELA") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_TIPO"     , "04", "Tipo"      , "Tipo"      , NIL, "C", PesqPict("SE1", "E1_TIPO")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_VALOR"    , "05", "Vlr.Titulo", "Vlr.Titulo", NIL, "N", PesqPict("SE1", "E1_VALOR")   , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_CLIENTE"  , "06", "Cliente"   , "Cliente"   , NIL, "C", PesqPict("SE1", "E1_CLIENTE") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_LOJA"     , "07", "Loja"      , "Loja"      , NIL, "C", PesqPict("SE1", "E1_LOJA")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_NOMCLI"   , "08", "Fantasia"  , "Fantasia"  , NIL, "C", PesqPict("SE1", "E1_NOMCLI")  , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)

    oStruct:AddField("E1_EMISSAO"  , "09", "Emissão"    , "Emissão"    , NIL, "D", PesqPict("SE1", "E1_EMISSAO") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_VENCORI"  , "10", "Vencto.Orig", "Vencto.Orig", NIL, "D", PesqPict("SE1", "E1_VENCORI") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_VENCTO"   , "11", "Vencimento" , "Vencimento" , NIL, "D", PesqPict("SE1", "E1_VENCTO")  , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_VENCREA"  , "12", "Vencto.Real", "Vencto.Real", NIL, "D", PesqPict("SE1", "E1_VENCREA") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_PROPOS"   , "13", "Proposta"   , "Proposta"   , NIL, "C", PesqPict("SE1", "E1_PROPOS")  , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_HIST"     , "14", "Histórico"  , "Histórico"  , NIL, "C", PesqPict("SE1", "E1_HIST")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_XNUMNFS"  , "15", "Numero NF"  , "Numero NF"  , NIL, "C", PesqPict("SE1", "E1_XNUMNFS") , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_XDTREC"   , "16", "Dt.NFSe"    , "Dt.NFSe"    , NIL, "C", PesqPict("SE1", "E1_XDTREC")  , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_PIS"      , "17", "PIS"        , "PIS"        , NIL, "N", PesqPict("SE1", "E1_PIS")     , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_COFINS"   , "18", "COFINS"     , "COFINS"     , NIL, "N", PesqPict("SE1", "E1_COFINS")  , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_CSLL"     , "19", "CSLL"       , "CSLL"       , NIL, "N", PesqPict("SE1", "E1_CSLL")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_IRRF"     , "20", "IRRF"       , "IRRF"       , NIL, "N", PesqPict("SE1", "E1_IRRF")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_ISS"      , "21", "ISS"        , "ISS"        , NIL, "N", PesqPict("SE1", "E1_ISS")     , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
    oStruct:AddField("E1_INSS"     , "22", "INSS"       , "INSS"       , NIL, "N", PesqPict("SE1", "E1_INSS")    , NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, .T., NIL, NIL, NIL)
EndIf
...
If nOpcao == 1	//Model
    ...
    oStruct:SetProperty("EV_NATUREZ", MODEL_FIELD_VALID, {|| U_PMS20NAT(1) })
    oStruct:SetProperty("EV_VALOR"  , MODEL_FIELD_VALID, {|| U_PMS20NAT(2) })
    oStruct:SetProperty("EV_PERC"   , MODEL_FIELD_VALID, {|| U_PMS20NAT(3) })
...
If nOpcao == 1	//Model
    ...
    oStruct:SetProperty("EZ_CCUSTO" , MODEL_FIELD_VALID, {|| U_PMS20CC(1) })
    oStruct:SetProperty("EZ_VALOR"  , MODEL_FIELD_VALID, {|| U_PMS20CC(2) })
    oStruct:SetProperty("EZ_PERC"   , MODEL_FIELD_VALID, {|| U_PMS20CC(3) })
...
ADD OPTION aRotina TITLE "Visualizar"       ACTION "VIEWDEF.ALFPMS20" 	OPERATION 2 ACCESS 0
ADD OPTION aRotina TITLE "Rateio"           ACTION "VIEWDEF.ALFPMS20" 	OPERATION 4 ACCESS 0
ADD OPTION aRotina TITLE "Excluir"          ACTION "VIEWDEF.ALFPMS20" 	OPERATION 5 ACCESS 0
ADD OPTION aRotina TITLE "Legenda" 		    ACTION "U_PMS20LEG"	    	OPERATION 8 ACCESS 0

Return aRotina

//-------------------------------------------------------------------
/*/{Protheus.doc} PMS20LEG
Legenda.
...
/*/
//-------------------------------------------------------------------
Static Function PMS20ACT(oModel)
...
/*/
//-------------------------------------------------------------------
Static Function LoadSE1(oFieldModel)
...
For nX := 1 To Len(aCampos)
    ...
    nPos := SE1->(FieldPos(cCampo))

    If nPos > 0
        AADD( aDados, SE1->(FieldGet(nPos)) )
    Else
        DO CASE
            CASE cTipo == "N"
                AADD( aDados, 0 )
...
cQuery += "     AND SEZ.EZ_CLIFOR = '"+SE1->E1_CLIENTE+"' "+ CRLF
cQuery += "     AND SEZ.EZ_LOJA = '"+SE1->E1_LOJA+"' "+ CRLF
cQuery += "     AND SEZ.EZ_NATUREZ = '"+cNaturez+"' "+ CRLF
cQuery += "     AND SEZ.EZ_RECPAG = 'R' "+ CRLF
...
oModel := FWLoadModel("ALFPMS20")

FWExecView(cTela, "ALFPMS20", nOpc, /*oDlg*/, /*bCloseOnOk*/, /*bOk*/, /*nPercReducao*/, /*aBtnView*/, /*bCancel*/, /*cOperatId*/, /*cToolBar*/, oModel)
...
Local oModSE1	:= oModel:GetModel("SE1MASTER")
...
cChave := oModSE1:GetValue("E1_PREFIXO")
cChave += oModSE1:GetValue("E1_NUM")
cChave += oModSE1:GetValue("E1_PARCELA")
cChave += oModSE1:GetValue("E1_TIPO")
cChave += oModSE1:GetValue("E1_CLIENTE")
cChave += oModSE1:GetValue("E1_LOJA")
...
For nX := 1 to oModSEV:Length()
    ...
    RecLock("SEV",.T.)
        ...
        REPLACE EV_PREFIXO  WITH oModSE1:GetValue("E1_PREFIXO")
        REPLACE EV_NUM      WITH oModSE1:GetValue("E1_NUM")
        REPLACE EV_PARCELA  WITH oModSE1:GetValue("E1_PARCELA")
        REPLACE EV_TIPO     WITH oModSE1:GetValue("E1_TIPO")
        REPLACE EV_CLIFOR   WITH oModSE1:GetValue("E1_CLIENTE")
        REPLACE EV_LOJA     WITH oModSE1:GetValue("E1_LOJA")
    ...
    For nY := 1 to oModSEZ:Length()
        ...
        RecLock("SEZ",.T.)
            ...
            REPLACE EZ_PREFIXO  WITH oModSE1:GetValue("E1_PREFIXO")
            REPLACE EZ_NUM      WITH oModSE1:GetValue("E1_NUM")
            REPLACE EZ_PARCELA  WITH oModSE1:GetValue("E1_PARCELA")
            REPLACE EZ_TIPO     WITH oModSE1:GetValue("E1_TIPO")
            REPLACE EZ_CLIFOR   WITH oModSE1:GetValue("E1_CLIENTE")
            REPLACE EZ_LOJA     WITH oModSE1:GetValue("E1_LOJA")
...
/*/
//-------------------------------------------------------------------
User Function PMS20NAT(nTipo)

Local oView    := FWViewActive()
Local oModel   := FWModelActive()
Local oSE1     := oModel:GetModel('SE1MASTER')
Local oSEV     := oModel:GetModel('SEVDETAIL')
Local oSEZ     := oModel:GetModel('SEZDETAIL')
Local nVlrTit  := oSE1:GetValue("E1_VALOR")
...
DO CASE
    CASE nTipo == 1
        ...
        DO CASE
            ...
            CASE !(SED->ED_USO $ "0,1")
                Help(Nil,Nil,ProcName(),,"Natureza infomada não está disponivel para utilização no contas a receber.", 1, 5)
...
Local nVlrTitulo := oModelPai:GetModel('SE1MASTER'):GetValue("E1_VALOR")
...
nRetorno := Round(nRetorno, TamSX3("E1_VALOR")[2])
...
Local oModSEV	:= oModel:GetModel("SEVDETAIL")
Local oModSEZ	:= oModel:GetModel("SEZDETAIL")
Local nVlrTit   := oModSE1:GetValue("E1_VALOR")
Local cCodNat   := ""
Local cNaturez  := ""
Local cCodCC    := ""
Local nTotNat   := 0
